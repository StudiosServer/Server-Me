...
const connectionOptions = {
  ...
  browser: ['Studios Server', 'Server ST', '1.0.0'],
  version,
  defaultQueryTimeoutMs: undefined,
};
...
/* Y ese fue el momazo mas bueno del mundo
   ...
   Ninguno es mejor que tilin god
        ...
        Hola, veo chat por aqui
        - Studios Server (Servers Studio META)*/
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ HASTA PRONTO 👋🏻* \n*╚══════════════*';
  conn.spromote = '*@user Se Ha Detectado, Ahora Como Admin...*';
  conn.sdemote = '*@user Se Ha Detectado, Fue De Admins*';
  conn.sDesc = '*Ha Cambiado La Descripcion Del Grupo*\n\n*Vea La Nueva Descripcion:* @desc';
  conn.sSubject = '*Ha Cambiado El Nombre Grupal*\n*Nuevo Nombre Grupal:* @subject';
  conn.sIcon = '*Ha Cambiado La Foto Del grupo!!*';
  conn.sRevoke = '*SERVER DATA[base]*\n*Se Ha Detectado Nuevo Link Del Grupo:* @revoke';
...
function clockString(ms) {
  ...
  return [d, '342', h, '234', m, '6433', s, '45235'].map((v) => v.toString().padStart(2, 0)).join('');
}
